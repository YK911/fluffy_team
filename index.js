import{a as W,i as h,S as z,N as te,P as ne,A as oe,R as ae,b as _}from"./assets/vendor-DfcDIlvk.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();const re=document.querySelector(".header-burger-menu"),F=document.querySelector(".header-modal"),se=document.querySelector(".modal-close-button");document.querySelector(".modal-navigation-item");const ie=document.querySelector(".modal-navigation-list"),le=document.querySelector(".modal-button");function B(e){F.classList.remove("is-open"),document.body.classList.remove("is-modal-open"),document.removeEventListener("keydown",J)}function J(e){e.key==="Escape"&&B()}le.addEventListener("click",B);re.addEventListener("click",e=>{e.preventDefault(),F.classList.add("is-open"),document.body.classList.add("is-modal-open"),document.addEventListener("keydown",J)});se.addEventListener("click",B);ie.addEventListener("click",e=>{e.target.classList.contains("modal-navigation-link")&&B()});const s={categoryList:document.querySelector(".js-category-list"),petsList:document.querySelector(".js-pets-list"),loader:document.querySelector(".js-loader"),petsLoadMoreBtn:document.querySelector(".js-pets-load-more-btn"),petsListPagination:document.querySelector(".pagination"),animalDetailsBackdrop:document.querySelector(".animal-details-backdrop")},w={page:1,limit:6},ce="https://paw-hut.b.goit.study/api",$={animals:"/animals",categories:"/categories",orders:"/orders",feedbacks:"/feedbacks"},q=W.create({baseURL:ce});async function de(e=w.page){try{const t=typeof w.limit=="number"&&w.limit>0?w.limit:6,n=typeof e=="number"&&e>=1?e:1;return(await q.get(`${$.feedbacks}`,{params:{limit:t,page:n}})).data.feedbacks}catch{return null}}function g(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch(n){console.error("Error saving to LocalStorage:",n)}}function K(e){try{const t=localStorage.getItem(e);return t?JSON.parse(t):null}catch(t){return console.error("Error loading from LocalStorage:",t),null}}const A="/fluffy_team/assets/sprite-C5gMIK71.svg";s.animalDetailsBackdrop.addEventListener("click",pe);function G(e,t){if(e.target.nodeName!=="BUTTON")return;const r=e.target.closest("li").dataset.id,a=t.find(l=>l._id===r);if(!a)return;ue(a),s.animalDetailsBackdrop.classList.add("is-open"),document.body.style.overflow="hidden",window.addEventListener("keydown",Q),document.querySelector(".details-modal-close-btn").addEventListener("click",O);const c=document.querySelector(".modal-adopt-btn");a._id,c&&c.addEventListener("click",()=>{window.dispatchEvent(new CustomEvent("open-order-modal",{detail:{animalId:a._id}}))})}function ue({_id:e,name:t,image:n,species:r,age:a,gender:o,description:c,healthStatus:l,behavior:d}){const p=`
  ...
  `;s.animalDetailsBackdrop.innerHTML=p}function O(){s.animalDetailsBackdrop.classList.remove("is-open"),document.body.style.overflow="",window.removeEventListener("keydown",Q)}function Q(e){e.code==="Escape"&&O()}function pe(e){e.currentTarget===e.target&&O()}let D=me(),i=K("page"),N,m=K("categoryId")??null;document.addEventListener("DOMContentLoaded",fe);s.petsLoadMoreBtn.addEventListener("click",ye);s.categoryList.addEventListener("click",ge);s.petsListPagination.addEventListener("click",ve);function me(){return window.innerWidth>=1440?9:8}function H(){return Math.ceil(N/D)}async function fe(e){M(),i=1,m=null,g("page",1),g("categoryId",null);try{const t=await he(),n=await x();we(t),j(n),U(),k(),s.petsList.addEventListener("click",r=>G(r,n))}catch{h.error({title:"Помилка",message:"Щось пішло не так",position:"topRight"})}finally{C()}}async function ge(e){if(e.target.nodeName!=="BUTTON")return;const t=e.target.textContent;m=e.target.closest("li").dataset.id,i=1;let r;M(),s.categoryList.querySelectorAll(".category-btn").forEach(o=>{o.classList.remove("current")}),e.target.classList.add("current");try{t!=="Всі"?r=await R(m,i):r=await x(),j(r),k(),U(),s.petsList.addEventListener("click",o=>G(o,r))}catch{h.error({title:"Помилка",message:"Щось пішло не так",position:"topRight"})}finally{C(),g("categoryId",m),g("page",i)}}async function ye(){i+=1,s.loader.classList.add("loader-center"),M();try{if(m){k();const t=await R(m,i),n=I(t);s.petsList.insertAdjacentHTML("beforeend",n)}else{k();const t=await x(i),n=I(t);s.petsList.insertAdjacentHTML("beforeend",n)}const e=s.petsList.querySelector("li");if(e){const t=e.getBoundingClientRect();window.scrollBy({top:t.height,behavior:"smooth"})}}catch{h.error({title:"Помилка",message:"Щось пішло не так",position:"topRight"})}finally{C(),g("page",i),s.loader.classList.remove("loader-center")}}async function ve(e){const t=e.target.closest("button");if(!t)return;let n;s.loader.classList.add("loader-center"),M();const r=H();t.dataset.action==="prev"&&i>1&&(i-=1),t.dataset.action==="next"&&i<r&&(i+=1),t.dataset.page&&(i=Number(t.dataset.page));try{m?n=await R(m,i):n=await x(i),j(n),U(),window.scrollTo({top:s.petsList.offsetTop-80,behavior:"smooth"})}catch{h.error({title:"Помилка",message:"Щось пішло не так",position:"topRight"})}finally{C(),s.loader.classList.remove("loader-center"),g("page",i)}}async function he(e){return(await q.get(`${$.categories}`)).data}async function x(e){const t=await q.get(`${$.animals}`,{params:{limit:D,page:e}});return N=t.data.totalItems,t.data.animals}async function R(e,t){const n=await q.get(`${$.animals}?categoryId=${e}`,{params:{limit:D,page:t}});return N=n.data.totalItems,n.data.animals}function Le(e){return`
     ...
     <div class="pets-img-wrapper"><img class="pets-img" src="${n}" alt="${t} - ${r}" /></div>
      ...
      </li>`}function I(e){return e.map(Se).join("")}function j(e){const t=I(e);s.petsList.innerHTML=t}function U(){const e=H();if(e<=1)return;let t="";if(t+=`<li>
      <button class="pagination-btn-arrow" data-action="prev" aria-label="Попередня сторінка" ${i===1?"disabled":""}>
        <svg class="arrow-icon" aria-hidden="true" width="24" height="24">
          <use href="${A}#icon-arrow-back"></use>
        </svg>
      </button>
      ...
      <button class="pagination-btn-arrow" data-action="next" aria-label="Наступна сторінка" ${i===e?"disabled":""}>
        <svg class="arrow-icon" aria-hidden="true" width="24" height="24">
          <use href="${A}#icon-arrow-forward"></use>
        </svg>
      </button>
