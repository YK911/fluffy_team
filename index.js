import{a as W,i as h,S as z,N as ne,P as oe,A as ae,R as re,b as _}from"./assets/vendor-DfcDIlvk.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();const F=document.querySelector(".header-burger-menu"),J=document.querySelector(".header-modal"),se=document.querySelector(".modal-close-button");document.querySelector(".modal-navigation-item");const ie=document.querySelector(".modal-navigation-list"),le=document.querySelector(".modal-button");function B(e){J.classList.remove("is-open"),document.body.classList.remove("is-modal-open"),document.removeEventListener("keydown",K),F.blur()}function K(e){e.key==="Escape"&&B()}le.addEventListener("click",B);F.addEventListener("click",e=>{e.preventDefault(),J.classList.add("is-open"),document.body.classList.add("is-modal-open"),document.addEventListener("keydown",K)});se.addEventListener("click",B);ie.addEventListener("click",e=>{e.target.classList.contains("modal-navigation-link")&&B()});const s={categoryList:document.querySelector(".js-category-list"),petsList:document.querySelector(".js-pets-list"),loader:document.querySelector(".js-loader"),petsLoadMoreBtn:document.querySelector(".js-pets-load-more-btn"),petsListPagination:document.querySelector(".pagination"),animalDetailsBackdrop:document.querySelector(".animal-details-backdrop")},w={page:1,limit:6},ce="https://paw-hut.b.goit.study/api",$={animals:"/animals",categories:"/categories",orders:"/orders",feedbacks:"/feedbacks"},q=W.create({baseURL:ce});async function de(e=w.page){try{const t=typeof w.limit=="number"&&w.limit>0?w.limit:6,n=typeof e=="number"&&e>=1?e:1;return(await q.get(`${$.feedbacks}`,{params:{limit:t,page:n}})).data.feedbacks}catch{return null}}function g(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch(n){console.error("Error saving to LocalStorage:",n)}}function Y(e){try{const t=localStorage.getItem(e);return t?JSON.parse(t):null}catch(t){return console.error("Error loading from LocalStorage:",t),null}}const I="/fluffy_team/assets/sprite-C5gMIK71.svg";s.animalDetailsBackdrop.addEventListener("click",pe);function G(e,t){if(e.target.nodeName!=="BUTTON")return;const r=e.target.closest("li").dataset.id,a=t.find(l=>l._id===r);if(!a)return;ue(a),s.animalDetailsBackdrop.classList.add("is-open"),document.body.style.overflow="hidden",window.addEventListener("keydown",Q),document.querySelector(".details-modal-close-btn").addEventListener("click",O);const c=document.querySelector(".modal-adopt-btn");a._id,c&&c.addEventListener("click",()=>{window.dispatchEvent(new CustomEvent("open-order-modal",{detail:{animalId:a._id}}))})}function ue({_id:e,name:t,image:n,species:r,age:a,gender:o,description:c,healthStatus:l,behavior:d}){const p=`
