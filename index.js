import{a as z,i as h,S as J,N as oe,P as ae,A as re,R as se,b as V}from"./assets/vendor-DfcDIlvk.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const d of o.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&r(d)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();const s={categoryList:document.querySelector(".js-category-list"),petsList:document.querySelector(".js-pets-list"),loader:document.querySelector(".js-loader"),petsLoadMoreBtn:document.querySelector(".js-pets-load-more-btn"),petsListPagination:document.querySelector(".pagination"),animalDetailsBackdrop:document.querySelector(".animal-details-backdrop")},w={page:1,limit:6},P="/fluffy_team/assets/sprite-C5gMIK71.svg";function g(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch(n){console.error("Error saving to LocalStorage:",n)}}function O(e){try{const t=localStorage.getItem(e);return t?JSON.parse(t):null}catch(t){return console.error("Error loading from LocalStorage:",t),null}}let ie=null;function le(){return ie}s.animalDetailsBackdrop.addEventListener("click",ue);function ce(e){const n=O("animals").find(d=>d._id===e);if(!n)return;de(n),s.animalDetailsBackdrop.classList.add("is-open"),document.body.style.overflow="hidden";const r=document.querySelector(".animal-modal");N(r);const a=document.querySelector(".details-modal-close-btn");window.addEventListener("keydown",Y),a.addEventListener("click",H);const o=document.querySelector(".modal-adopt-btn");o&&o.addEventListener("click",()=>{window.dispatchEvent(new CustomEvent("open-order-modal",{detail:{animalId:n._id}}))})}function de({_id:e,name:t,image:n,species:r,age:a,gender:o,description:d,healthStatus:l,behavior:c}){const p=`
  ...
  `;s.animalDetailsBackdrop.innerHTML=p}function H(){s.animalDetailsBackdrop.classList.remove("is-open"),document.body.style.overflow="",window.removeEventListener("keydown",Y)}function Y(e){e.code==="Escape"&&H()}function ue(e){e.currentTarget===e.target&&H()}function N(e){e.focus();const n=e.querySelectorAll(`
    a[href],
    button:not([disabled]),
    textarea,
    input,
  ...
  `),r=n[0],a=n[n.length-1];e.addEventListener("keydown",o=>{o.key==="Tab"&&(o.shiftKey&&document.activeElement===r&&(o.preventDefault(),a.focus()),!o.shiftKey&&document.activeElement===a&&(o.preventDefault(),r.focus()))})}const G=document.querySelector(".header-burger-menu"),I=document.querySelector(".header-modal"),pe=document.querySelector(".modal-close-button");document.querySelector(".modal-navigation-item");const me=document.querySelector(".modal-navigation-list"),fe=document.querySelector(".modal-button");function B(e){I.classList.remove("is-open"),document.body.classList.remove("is-modal-open"),document.removeEventListener("keydown",Q),G.blur()}function Q(e){e.key==="Escape"&&B()}fe.addEventListener("click",B);G.addEventListener("click",e=>{e.preventDefault(),I.classList.add("is-open"),document.body.classList.add("is-modal-open"),document.addEventListener("keydown",Q),N(I)});pe.addEventListener("click",B);me.addEventListener("click",e=>{e.target.classList.contains("modal-navigation-link")&&B()});const ge="https://paw-hut.b.goit.study/api",q={animals:"/animals",categories:"/categories",orders:"/orders",feedbacks:"/feedbacks"},$=z.create({baseURL:ge});async function ye(e=w.page){try{const t=typeof w.limit=="number"&&w.limit>0?w.limit:6,n=typeof e=="number"&&e>=1?e:1;return(await $.get(`${q.feedbacks}`,{params:{limit:t,page:n}})).data.feedbacks}catch{return null}}let R=ve(),i=O("page"),j,m=O("categoryId")??null;document.addEventListener("DOMContentLoaded",he);s.petsLoadMoreBtn.addEventListener("click",Le);s.categoryList.addEventListener("click",be);s.petsListPagination.addEventListener("click",we);s.petsList.addEventListener("click",Se);function ve(){return window.innerWidth>=1440?9:8}function U(){return Math.ceil(j/R)}async function he(e){C(),i=1,m=null,g("page",1),g("categoryId",null);try{const t=await Ee(),n=await x();qe(t),F(n),K(),k()}catch{h.error({title:"Помилка",message:"Щось пішло не так",position:"topRight"})}finally{M()}}async function be(e){if(e.target.nodeName!=="BUTTON")return;const t=e.target.textContent;m=e.target.closest("li").dataset.id,i=1;let r;C(),s.categoryList.querySelectorAll(".category-btn").forEach(o=>{o.classList.remove("current")}),e.target.classList.add("current");try{t!=="Всі"?r=await _(m,i):r=await x(),F(r),k(),K()}catch{h.error({title:"Помилка",message:"Щось пішло не так",position:"topRight"})}finally{M(),g("categoryId",m),g("page",i)}}async function Le(){i+=1,s.loader.classList.add("loader-center"),C();try{if(m){k();const t=await _(m,i),n=D(t);s.petsList.insertAdjacentHTML("beforeend",n)}else{k();const t=await x(i),n=D(t);s.petsList.insertAdjacentHTML("beforeend",n)}const e=s.petsList.querySelector("li");if(e){const t=e.getBoundingClientRect();window.scrollBy({top:t.height,behavior:"smooth"})}}catch{h.error({title:"Помилка",message:"Щось пішло не так",position:"topRight"})}finally{M(),g("page",i),s.loader.classList.remove("loader-center")}}async function we(e){const t=e.target.closest("button");if(!t)return;let n;s.loader.classList.add("loader-center"),C();const r=U();t.dataset.action==="prev"&&i>1&&(i-=1),t.dataset.action==="next"&&i<r&&(i+=1),t.dataset.page&&(i=Number(t.dataset.page));try{m?n=await _(m,i):n=await x(i),F(n),K(),window.scrollTo({top:s.petsList.offsetTop-80,behavior:"smooth"});const a=s.petsList.querySelector("li");a&&a.focus()}catch{h.error({title:"Помилка",message:"Щось пішло не так",position:"topRight"})}finally{M(),s.loader.classList.remove("loader-center"),g("page",i)}}function Se(e){const t=e.target.closest(".pets-button");if(!t)return;const n=t.closest("li");if(!n)return;const r=n.dataset.id;ce(r)}async function Ee(e){return(await $.get(`${q.categories}`)).data}async function x(e){const t=await $.get(`${q.animals}`,{params:{limit:R,page:e}});return j=t.data.totalItems,t.data.animals}async function _(e,t){const n=await $.get(`${q.animals}?categoryId=${e}`,{params:{limit:R,page:t}});return j=n.data.totalItems,n.data.animals}function ke(e){return`
     <li class="category-item" data-id="${e._id}">
      ...
      </li>${Be(e)}`;s.categoryList.innerHTML=t}function $e({_id:e,name:t,image:n,species:r,age:a,gender:o,categories:d,description:l}){const c=d.map(p=>`<li class="pets-category-item">${p.name}</li>`).join("");return`
     ...
     <div class="pets-img-wrapper"><img class="pets-img" src="${n}" alt="${t} - ${r}" /></div>
      ...
      </li>`}function D(e){return e.map($e).join("")}function F(e){const t=D(e);s.petsList.innerHTML=t,g("animals",e)}function K(){const e=U();if(e<=1)return;let t="";if(t+=`<li>
